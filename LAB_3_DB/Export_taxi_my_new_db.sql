...
--
-- Host: localhost    Database: new_mydb
-- ------------------------------------------------------
...
INSERT INTO `additional_options` VALUES (1,'кондиционер'),(2,'массажное кресло'),(3,'доставка посылки'),(4,'детское кресло'),(5,'Wi-Fi'),(6,'перевозка грузов'),(7,'массаж'),(8,'увлажнитель воздуха'),(9,'светомузыка'),(10,'перевоз велосипеда');
...
INSERT INTO `additional_options_has_trips` VALUES (1,90),(2,91),(3,92),(4,93),(5,94),(6,95);
...
INSERT INTO `clients` VALUES (30,78005553535,'QuanRy'),(31,79021527509,'4DKBS'),(32,79046107217,'Damisty'),(33,79193337290,'Lucky_Grin'),(34,79213727262,'Tinker_Drinker'),(35,79027432121,'Ivan_Paymon'),(36,79214567357,'Никитка'),(37,79746172574,'Старый_гусь'),(38,78954657251,'Pozhiloy_Ded'),(39,79023746785,'Ded_inside');
...
CREATE TABLE `forms_of_payment` (
  `id_forms-of_payment` int NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id_forms-of_payment`)
...
INSERT INTO `taxi_drivers` VALUES (60,'Urat_driver',10),(61,'Mackvin',22),(62,'Puper_Uber',5),(63,'Bog_taxi',7),(64,'Uros_Boros',31),(65,'Gregory',15),(66,'Rus_Indus',8),(67,'_FeDor_Pump',13),(68,'Арарат',23),(69,'I_m_investor',15);
...
CREATE TABLE `trips` (
  ...
  CONSTRAINT `fk_trips_forms-of_payment1` FOREIGN KEY (`forms_of_payment_id_forms_of_payment`) REFERENCES `forms_of_payment` (`id_forms-of_payment`),
...
-- Dump completed on 2022-04-12  0:04:38
